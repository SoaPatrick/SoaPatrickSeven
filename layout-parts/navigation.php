...
<nav class="site-navigation">
  <a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="SoaPatrick">
    ...
    <svg aria-hidden="true" focusable="false" class="site-navigation__logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 894.28 1024">
  ...
  <a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>storage" aria-label="Storage">
    <span>Storage</span>
  ...
  <a class="site-navigation__link" href="<?php echo esc_url( home_url( '/' ) ); ?>factory" aria-label="Factory">
    <span>Factory</span>
    <svg aria-hidden="true" focusable="false" class="site-navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      <g class="fa-group">
  ...
  <span class="site-navigation__link" aria-label="Settings" id="toggle-settings">
    <span>Settings</span>
    <svg aria-hidden="true" focusable="false" class="site-navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      <g class="fa-group">
  ...
  <spam class="site-navigation__link" aria-label="Find stuff" id="toggle-search-collapse">
    <span>Find stuff</span>
    <svg aria-hidden="true" focusable="false" class="site-navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      <g class="fa-group">
